...
def gen_wordlist(topic, native_language, target_language, extra_field, count) -> WordList:
    ...
    result = _gen_wordlist_uncached(topic, native_language, target_language, extra_field, count)
    with open(cache_file, "w") as f:
        f.write(result.model_dump_json())
    return result


def _gen_wordlist_uncached(topic, native_language, target_language, extra_field, count) -> WordList:
